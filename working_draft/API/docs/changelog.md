...
- use hasDataHolder instead of hasDataOnwer into ServerInformation class
...
- removed `hasSupportedLogisticsObjectType` from ServerInformation data class
...
- added `hasLogisticsObjectType` in Notification data class
